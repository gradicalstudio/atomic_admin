...
export default function PrivateOffice({ data, loading }) {
  return (
    <Formik
      initialValues={{
        heading:
          data && data.spaceOverviewSection.privateDesk.heading
            ? data.spaceOverviewSection.privateDesk.heading
            : "",
        subHeading:
          data && data.spaceOverviewSection.privateDesk.paragraph
            ? data.spaceOverviewSection.privateDesk.paragraph
            : "",
      }}
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-7">
                ...
                <p className="text-gray-400">
                  Edit contents, add images to the Private office section here.
                </p>
              </div>
              <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  <div className=" h-40 w-40 overflow-auto">
                    <img
                      src={data.spaceOverviewSection.privateDesk.image}
                      alt=""
                    />
                  </div>
